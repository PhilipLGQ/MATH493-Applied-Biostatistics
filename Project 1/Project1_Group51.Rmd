...
```{r diag, results='hide', fig.height=4, fig.width=12, fig.cap="3-way ANOVA assesment", echo=FALSE}
...
the 5 types of varieties and 7 types of fusarium strains : If the
interval does not include zero then the difference is significant.

```{r results='hide', fig.width=8, fig.height=5, out.width="100%", echo=FALSE}
...
## IV. Conclusion
In order to compare the tree moisture in different types of species, locations and transpiration statistically, we implement a 3-way ANOVA
...
difference in the tree moisture by species, location, transpiration and combination of species with transpiration, combination of locations with transpiration. However, due to the nature of the
